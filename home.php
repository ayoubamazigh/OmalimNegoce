            ...
            <nav class="navbar navbar-expand-lg  navbar-dark bg-dark">
                ...
                <div class="collapse justify-content-between navbar-collapse" id="navbarTogglerDemo01">
                    ...
                    <form class="form-inline my-lg-0 ">
                        ...
                        <button class="btn my-btn-brahim my-2 my-sm-0 " type="submit">Inox Industriel</button>
                    </form>
                </div>
            </nav>
                        ...
                        while($row = mysqli_fetch_array($result)){
                            ...
                            $html = <<<HTML
                                                    ...
                                                    <div class='container mb-4 mt-1' >
                                                        <div class='row'>
                                                            <div class='col-lg-4' >
                                                                <img class='product-image' src='$row[4]' >
                                                            </div>
                                                        <div class='col-lg-8' >
                                                    <div class='product-title' >
                                                        ...
                                                        <div class='product-caracriristiques' >
                                                            <table>
                                                                <tr>
                                                                    <td>Temp:</td>
                                                                    <td>$row[2]</td>
                            ...
                            <div class='my-fotter-insider' >
                                ...
                                <div class='my-footer-description' >
                                    <div class='my-footer-icons' >
                                        ...
                                        </svg> <a href='mailto:booxchange@gmail.com' style="color: white" > &nbsp;@Omalim_Negoce</a>
                                    </div>
                                    <div class='my-footer-icons' >
