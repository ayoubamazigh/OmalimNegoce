  ...
  <div class="collapse justify-content-between navbar-collapse" id="navbarTogglerDemo01">
    ...
    <form class="form-inline my-lg-0 ">
        ...
        <a href="home.php?type=in"><input type="button" value='Inox Industriel' class="btn my-btn-brahim my-2 my-sm-0 " ></a>
                            ...
                            <div class='col-lg-6 col-md-12 col-sm-12 my-selector' >
                                <div class='selector' >
                                    <div class='my-insider-image' > 
                                        ...
                                        <div class="my-title" >
                                            <a href="#">inox industriel</a>
                                        </div>
                                        <div class='my-desc' >
                                            L’inox est un métal constitué de divers éléments d’alliage. tout les travaux concernent l'Inox, fabrication des fenêtre, portes... avec une bonne qualité, et meilleur prix.
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class='container-fluid bg-dark my-fotter ' >
                <div class='row' >
                    
                    <div class='col-lg-4 col-sm-12 bg-dark '>
                        <div id='Proposdenous' class='my-fotter-insider' >
                            à Propos de nous                         
                            <div class='my-sep1' ></div>
                            <div class='my-footer-description' >
                                <ul>
                                    <li>Nom: OMALIM NEGOCE sarl</li>
                                    <li>Adresse: Cite Bir Anzarane, 85 C, Tikiouine</li>
                                    <li>Telephone: +212661932776</li>
                                    <li>Company type: Single associate sarl</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class='col-lg-4 col-sm-12 bg-dark '>
                        ...
                        <div id='notreservices' class='my-fotter-insider' >
                            notre services &nbsp;
                            <div class='my-sep2' ></div>
                            <div class='my-footer-description2' >
                                <table>
                                    <tr>
                                        <td>Service aluminium: &nbsp;</td>
                                        <td><a href="home.php?type=al"><input type="button" value="Aluminium Industriel" class="btn my-btn-brahim my-2 my-sm-0" ></a></td>
                                    </tr> 
                                    <tr>
                                        <td><br>Inox Indestriel: &nbsp;</td>
                                        <td><br ><a href="home.php?type=in"><input type="button" value='Inox Industriel' class="btn my-btn-brahim my-2 my-sm-0 " ></a></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                    ...
                    <div class='col-lg-4 col-sm-12 bg-dark '>
                        <div class='my-fotter-insider' >
                        <div id='contacternos' class='my-fotter-insider' >
                            contacter nos &nbsp;&nbsp;
                            ...
                            <div class='my-footer-description' >
                                <div class='my-footer-icons' >
                                    ...
                                    </svg> <a href='mailto:omalimnegoce@gmail.com' style="color: white" > &nbsp;@Omalim_Negoce</a>
                                    </div>
                                    <div class='my-footer-icons' >
