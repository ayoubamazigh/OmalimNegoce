                        ...
                        if($connection){
                            ...
                            if($db){  
                                ...
                                if($result){
                                    ...
                                    echo "<script> alert('Article deleted avec success'); </script>";
                            ...
                            if(in_array($imgextention, $allowed_exs)){
                                ...
                                if($connection){
                                    ...
                                    if($db){
                                        ...
                                        if($inserted){
                                            echo "<script> alert('l'article a été ajouté avec succès')</script>";
                                            header('Location: login.php');
                                        }else{
                                            echo "<script> alert('l'article n'a pas été ajouté')</script>";
                                        }
                                    }
                                }    
                            }else{
...
<center><a href='clear.php' ><input type="button" value="logout" class='logout-btn m-3 w-25 bg-danger' /></a></center>
